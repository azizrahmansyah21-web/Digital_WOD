...
const PlateNumber = ({ plate, className = '' }) => {
  ...
  if (p2 === '') {
    return (
      <span className={`inline-flex justify-center items-center bg-white text-black font-plate rounded shadow-sm shrink-0 whitespace-nowrap overflow-hidden leading-none ${className}`}>
  ...
  return (
    <span className={`inline-flex justify-center items-center bg-white text-black font-plate rounded shadow-sm shrink-0 whitespace-nowrap overflow-hidden leading-none gap-2 ${className}`}>
      <span className="relative -top-[1px] md:-top-[2px]">{p1}</span>
